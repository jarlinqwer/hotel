...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Nuevo Archivo</button>
			<button class="btn btn-primary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Actualizar Archivo</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-12"><h4><b>Folder</b></h4></div>
		</div>
		<hr>
		<div class="row">
			<?php 
				...
				<div class="card-body">
					<table width="100%">
						<tr>
							...
							<th width="40%" class="">Descripcion</th>
						</tr>
						<?php 
...
//FILE
	...
	function delete_folder($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast("Carpeta Borrada Exitosamente.",'success')
						setTimeout(function(){
							location.reload()
						},1500)
				}
